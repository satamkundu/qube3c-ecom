...
?>
<?php
	if(isset($_GET['edit_fresh3c_product'])){
		$edit_id = $_GET['edit_fresh3c_product'];
...
if(isset($_POST['update'])){
	...
	$update_product = "update products set date=NOW(),product_title='$product_title',product_url='$product_url',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_desc='$product_desc',product_features='$product_features',product_keywords='$product_keywords',product_label='$product_label' where id='$p_id'";
